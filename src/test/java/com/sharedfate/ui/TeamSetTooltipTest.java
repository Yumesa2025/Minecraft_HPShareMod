 ...
 *
 * <p>툴팁은 <b>세트 줄에서만</b> 뜬다. 보유 증강 줄에는 설명이 이미 줄에 펼쳐져 있어
 * 상자가 그것을 덮는다. 줄을 만드는 계산이 {@link PerkSetTooltipLines} 이고, 여기서는
 * <b>팀 화면이 부르는 모양 그대로</b> 불러 본다.
 *
...
class TeamSetTooltipTest {
	...
	/**
	 * 네 줄이 같은 색으로 늘어서면 「지금 무엇이 켜져 있는가」에 아무 답도 못 한다.
	 */
	@Test
