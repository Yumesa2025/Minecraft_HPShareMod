...
/**
 * 인챈트 탁자의 <b>다이아몬드 칸</b>이다. 청금석 칸 바로 아래 줄에 있다.
 *
 * <p>빈 칸 아이콘은 26.2 에 이미 들어 있는 {@code container/slot/diamond} 를 쓴다 —
 * 청금석 칸이 {@code container/slot/lapis_lazuli} 를 쓰는 것과 같은 방식이다.
 * 칸의 <b>네모 바탕</b>만은 인챈트 탁자 그림에 없는 자리라
 * 화면 쪽에서 채워 넣는다({@link SelfPaintedSlot}).
 */
