 ...
 *
 * <p>인벤토리를 뒤져 걷지 않습니다. 그러면 어디에 얼마를 넣어야 하는지 화면에 아무 단서가
 * 없고, 인챈트를 누르는 순간 인벤토리 어딘가에서 다이아몬드가 조용히 사라집니다. 청금석 칸
 * 아래에 <b>진짜 칸</b>({@link EnchantmentDiamondSlot})을 두고 거기 있는 것만 셉니다.
 *
 * <h2>값을 바꾸려면</h2>
 *
 * <ul>
