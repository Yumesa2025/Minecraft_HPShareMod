 ...
 *
 * <p>위치 교환은 고정점 없는 완전 순열이라 누군가 방금 비운 자리는 언제나 다른 누군가의 새
 * 자리이기도 하다. 그 자리로 막 <b>도착한</b> 사람이 면역이 아니면 도착과 거의 동시에 그
 * 자리가 터져 즉사한다.
 *
 * <p>그래서 폭발을 {@value #DELAY_TICKS}틱 미루고, 그동안 이 교환에 참여한 사람
